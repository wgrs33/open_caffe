...
std::map<T_Part, std::vector<T_AnalogPort>> analog_map_parts{
    {T_Part::E_Brew, {BREW_UNIT_CURRENT}},         {T_Part::E_Grinder, {GRINDER_CURRENT}},
    {T_Part::E_GrinderDuo, {GRINDER_DUO_CURRENT}}, {T_Part::E_Heater, {TEMP_HEATER}},
    {T_Part::E_SteamHeater, {TEMP_STEAM_HEATER}},  {T_Part::E_CupHeater, {TEMP_CUP_HEATER}}};

std::map<T_Part, std::vector<T_CounterPort>> counter_map_parts{{T_Part::E_Grinder, {CGRINDER}},
...
std::map<T_Part, std::string> name_map_part{{T_Part::E_Brew, "Brew"},
